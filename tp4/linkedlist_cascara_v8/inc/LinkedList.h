 ...
 * \param Funcion que conoce la condicion para filtrar de los elementos
            devuelte 1 si el elemento cumple la condicion y 0 si no
 * \return Retorna una nueva lista con los elementos que cumplen la funcion.
 *
 */
